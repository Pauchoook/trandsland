(() => {
    ...
    function burger() {
        ...
        if (buttonsMenu.length) buttonsMenu.forEach((btn => {
    ...
    function services() {
        ...
        if (btnsServices.length) btnsServices.forEach((btn => {
            btn.addEventListener("click", (e => {
                e.stopPropagation();
    ...
    function more() {
        ...
        if (buttonsMore.length) buttonsMore.forEach((btn => {
        ...
        if (buttons.length) {
            buttons.forEach((btn => {
                btn.addEventListener("click", (e => {
                    ...
                    } else currentSelect.classList.remove("open");
                }));
            }));
    ...
    function map() {
        ...
        if (window.matchMedia("(max-width:743px)").matches) iconImageSize = [ 72, 72 ];
        if (contactsMap) {
            function init() {
    ...
    function show() {
        ...
        if (showParents.length) showParents.forEach((parent => {
            ...
            if (window.matchMedia(`(max-width: ${media}px)`).matches) Array.from(items).slice(0, startItem).forEach((item => item.classList.add("active")));
            btn.addEventListener("click", (() => {
                Array.from(items).slice(4, startItem + showItems).forEach((item => item.classList.add("active")));
                startItem += showItems;
